...
const EditMonitoringModal = ({ show, closeModal, monitoring, onSave }) => {
  ...
  const [initialMonitoringData, setInitialMonitoringData] = useState(null);
  ...
  useEffect(() => {
    if (show && monitoring) {
      const initialData = {
        ...
        fechaProgramada: monitoring.fecha_programada || '',
        fechaRealizada: monitoring.fechaRealizada || '',
      };
      ...
      setFechaRealizada(initialData.fechaRealizada);
      setInitialMonitoringData(initialData);
    }
  ...
  const isDataChanged = () => {
    return (
      ...
      fechaProgramada !== initialMonitoringData?.fechaProgramada ||
      fechaRealizada !== initialMonitoringData?.fechaRealizada
    );
  };
  ...
  const handleUpdateMonitoring = async () => {
    ...
    const monitoringData = {
      ...
      fecha_finalizacion: fechaRealizada,
    ...
    <>
      ...
      {showSuccessModal && (
        <SuccessModal
          ...
          onClose={handleCloseSuccessModal} // Llama a la función que refresca las cards
